...
<div class="container ">
  <div class="row">
    <div class="col-md-4">
      ...
      <h3 class="mt-2 mb-2">Thêm Tác Giả</h3>
      <form action="${pageContext.request.contextPath}/admin/author" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group row align-items-center ">
          <label class="col-md-12 form-control-label required" for="dob">
            DOB
          </label>
          <div class="col-md-12">
        ...
        <div class="form-group row align-items-center ">
          <label class="col-md-12 form-control-label required" for="nationality">
            Nationality
          </label>
          <div class="col-md-12">
            <select id="nationality" name="nationality" data-placeholder="Chọn quốc tịch" class="form-control">
              <option value=""></option>
        ...
        <div class="form-group row align-items-center ">
          <label class="col-md-12 form-control-label required" for="biography">
            Biography
          </label>
          <div class="col-md-12">
            <textarea class="form-control" name="biography" id="biography" style="width: 100%" rows="10"></textarea>
          </div>
        </div>
        <div class="form-group row d-flex justify-content-center ">
          <label class="col-md-11 form-control-label required btn btn-outline-primary-2 btn-block" for="image">
            Hình ảnh
          </label>
          <div class="col-md-12">
        ...
        <div class="form-group row align-items-center ">
          <div class="col-md-12">
            <button class="btn btn-primary btn-block" data-link-action="save-customer" type="submit">
              Thêm tác giả
            </button>
          </div>
        </div>
